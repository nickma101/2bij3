...
def newspage(show_again = 'False'):
    ...
    message_done_daily = "Je hebt het maximaal aantal punten voor vandaag gehaald. Log morgen weer in om je dagelijkse punten te halen. Vragen? Bekijk de FAQ of mail ons. Erste keer dat je 2bij3 hebt gebruikt? Gebruik dan de volgende code om uw beloning op Prolific te claimen: 1200AE29"
