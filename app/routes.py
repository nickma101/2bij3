...
def newspage(show_again = 'False'):
    ...
    message_done_daily = "Je hebt het maximaal aantal punten voor vandaag gehaald. Log morgen weer in om je dagelijkse punten te halen. Vragen? Bekijk de FAQ of mail ons."
